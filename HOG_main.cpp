...
int main()
{
    ...
    // Convert image to Float for HOG feature computation
    ...
    // Saving the pointer of host image to pass to GPU 
    ...
    // No of blocks and grids for CUDA kernel
    ...
    // Calculate time for calculating HOG featyres on GPU
    clock_gettime(CLOCK_REALTIME, &time1);

    // Core function to call the GPU kernel
...
//    }
    ...
    // Normalization of hog feature vectors.
